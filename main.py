...
classifier =load_model(r'C:\Users\Bruger\OneDrive\Dokumenter\ec_utbildning\deep_learning\kunskapskontroll\Emotion_Detection_CNN-main\model_1.keras')
...
if not cap.isOpened():
    print(f"Error: Could not open video stream on camera index {0}.")
else:
    while True:
        ret, frame = cap.read()
        if not ret:
